...
def minimax(board, depth, is_maximizing, current_player, opponent):
    """
    ...
    for move in possible_moves:
        ...
        score, _ = minimax( board, depth - 1, not is_maximizing, current_player, opponent)
...
def minimax_move(board):
    ...
    current_player = 2
    opponent = 1
    _, best_move = minimax(board.board, depth= 3, is_maximizing=True, current_player=current_player, opponent=opponent)
    return best_move
